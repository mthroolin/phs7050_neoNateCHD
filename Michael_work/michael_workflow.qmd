...
model1 =zoib(Percent_of_feeds_taken_by_mouth_at_discharge #Response
            ~Age_at_Surgery_days+Premature+GI_Complication #x1 design matrix
       | 1 #x2 design matrix
     |1 #x3 design matrix
     |1, #x4 design matrix
     data = nnns,
     ...
     link.x1 =  "logit",
     random = 0,
     n.chain = 2, # number of MCMC chains
     n.iter = 5000, #number of iterations before burn/thin
     n.thin = 5, # thinning period
     seeds = c(3,4) #vector of seeds for chains to make reproducable
     )
